...
const CreateEstatePage = () => {
  ...
  const createHandler = async () => {
    try {
      const res = await axios.post("http://localhost:3000/estate", {
        name, location, netM, brutM, roomC, aidat, furnished, floor, park, description, imagelink1, imagelink2, imagelink3, imagelink4 
      })
